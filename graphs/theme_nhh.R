theme_nhh <- function (base_size = 11, base_family = "") 
{
  ...
  theme(line = element_line(colour = "black", size = 0.5, linetype = 1, lineend = "butt"),
        ...
        axis.title.x = element_text(size = rel(2), margin = margin(t = 0.8 * half_line, b = 0.8 * half_line/2)),
        axis.title.y = element_text(size = rel(2), angle = 90, margin = margin(r = 0.8 * half_line, l = 0.8 * half_line/2)), 
        ...
        panel.border = element_rect(colour = "black", fill=NA, size = rel(.5)),
        ...
        strip.text = element_text(colour = "black", size = rel(2)),
        strip.text.x = element_text(margin = margin(t = half_line, b = half_line)),
        strip.text.y = element_text(angle = -90, margin = margin(l = half_line, r = half_line)),
        strip.switch.pad.grid = unit(0.1, "cm"),
        strip.switch.pad.wrap = unit(0.1, "cm"),
        plot.background = element_rect(colour = "white"), 
        plot.title = element_text(size = rel(2), margin = margin(b = half_line * 1.2)),
